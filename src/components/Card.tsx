...
export default function Card({ imgUrl, name, price, brand }: CardProps) {
  return (
    ...
    >
      <img
        className="lg:group-hover:scale-110"
        src={imgUrl}
        alt={name}
        width={200}
      />
      <div className="w-full flex flex-col items-center space-y-1 border-b-0 border-purple-600 py-2 border-10 lg:group-hover:border-x-0">
