  ...
  return (
    ...
    >
      <div className="w-full h-full relative text-white bg-linear-to-b from-black/25 backdrop-blur-40 flex items-center justify-center">
        ...
        <img
          className=" absolute top-31 left-15 rotate-[-30deg] lg:top-16 lg:left-118 lg:block"
        ...
        <img
          className="absolute top-62 left-32 lg:top-60 lg:left-76 lg:block"
        ...
        <img
          className=" absolute bottom-64 right-14 rotate-[-20deg] lg:bottom-55 lg:right-51 lg:block"
